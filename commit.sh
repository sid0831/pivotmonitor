...
VERSARRAY=( $(echo "$VERSINFO" | sed -E 's/([0-9]*)(\.)([0-9]*)(\.)([0-9]*)(\-)([0-9]*)(\.)([0-9]*)/\1/') $(echo "$VERSINFO" | sed -E 's/([0-9]*)(\.)([0-9]*)(\.)([0-9]*)(\-)([0-9]*)(\.)([0-9]*)/\3/') $(echo "$VERSINFO" | sed -E 's/([0-9]*)(\.)([0-9]*)(\.)([0-9]*)(\-)([0-9]*)(\.)([0-9]*)/\5/') $(echo "$VERSINFO" | sed -E 's/([0-9]*)(\.)([0-9]*)(\.)([0-9]*)(\-)([0-9]*)(\.)([0-9]*)/\7/') $(echo "$VERSINFO" | sed -E 's/([0-9]*)(\.)([0-9]*)(\.)([0-9]*)(\-)([0-9]*)(\.)([0-9]*)/\9/') )
...
verschange () {
  ...
  sed -E -i "s/([0-9]*)(\.)([0-9]*)(\.)([0-9]*)(\-)([0-9]*)(\.)([0-9]*)/${VERSARRAY[0]}.${VERSARRAY[1]}.${VERSARRAY[2]}\-${VERSARRAY[3]}.${VERSARRAY[4]}/g" $PWD/pivotmonitor.sh; QMARK=$?
  return $QMARK
}
